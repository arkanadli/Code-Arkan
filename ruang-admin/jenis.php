            ...
            <div class="col-xl-12 col-lg-7">
              ...
              <div class="card-body">
                ...
                <div class="container shadow-lg p-3 mb-5 bg-body rounded" style=" margin-top:0px; width:100%;">
                  <form method="POST" action="tambahJenis.php">
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $d['tahun_Keluaran']; ?></td>
                    <td><?php echo $d['tarif']; ?></td>
                    <td>
                      <a role="button" class="btn btn-info" href="editJenis.php?id=<?php echo $d['id_Jenis']; ?>">UBAH</a> </button>
                      <a role="button" class="btn btn-danger" href="hapusJenis.php?id=<?php echo $d['id_Jenis']; ?>">HAPUS</a></button>
                    </td>
                  </tr>
                <?php
                }
