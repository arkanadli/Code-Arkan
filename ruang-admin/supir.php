            ...
            <div class="col-xl-12 col-lg-7">
              ...
              <div class="card-body">
                ...
                <div class="container shadow-lg p-3 mb-5 bg-body rounded" style=" margin-top:0px; width:100%;">
                  <form method="POST" action="tambahSupir.php">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a role="button" class="btn btn-info" href="editSupir.php?id=<?php echo $d['id_Supir']; ?>">UBAH</a> </button>
                      <a role="button" class="btn btn-danger" href="hapusSupir.php?id=<?php echo $d['id_Supir']; ?>">HAPUS</a></button>
                    </td>
                  </tr>
                <?php
                }
