      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Brand Mobil</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-xl-12 col-lg-7">
              ...
              <div class="card-body">
                ...
                <div class="container shadow-lg p-3 mb-5 bg-body rounded" style=" margin-top:0px; width:100%;">
                  <form method="POST" action="tambahBrand.php">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a role="button" class="btn btn-info" href="editBrand.php?id=<?php echo $d['id_Brand']; ?>">UBAH</a> </button>
                      <a role="button" class="btn btn-danger" href="hapusBrand.php?id=<?php echo $d['id_Brand']; ?>">HAPUS</a></button>
                    </td>
                  </tr>
                <?php
                }
