      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Transaksi Penyewaan</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Transaksi Penyewaan</li>
            </ol>
          </div>
            ...
            <div class="col-xl-12 col-lg-7">
              ...
              <div class="card-body" style="width:100% ;">
                ...
                <div class="container shadow-lg p-3 mb-5 bg-body rounded" style=" margin-top:0px; width:100%;">
                  <form method="POST" action="tambahPenyewaan.php">
                ...
                include 'konek.php';
                $no = 1;
                $data = mysqli_query($koneksi, "select * from penyewaan");
                while ($d = mysqli_fetch_array($data)) {
                ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $d['id_Penyewaan']; ?></td>
                    <td><?php echo $d['id_Pelanggan']; ?></td>
                    <td><?php echo $d['id_Supir']; ?></td>
                    <td><?php echo $d['id_Mobil']; ?></td>
                    <td><?php echo $d['tanggal_Sewa']; ?></td>
                    <td><?php echo $d['akhir_Sewa']; ?></td>
                    <td><?php echo $d['status_Pembayaran']; ?></td>
                    <td><?php echo $d['total_Bayar']; ?></td>

                    <td>
                      <a role="button" class="btn btn-info" href="editPenyewaan.php?id=<?php echo $d['id_Penyewaan']; ?>">&nbsp; UBAH</a> </button>
                      <a role="button" class="btn btn-danger" href="hapusPenyewaan.php?id=<?php echo $d['id_Penyewaan']; ?>">HAPUS</a></button>
                    </td>
                  </tr>
                <?php
                }
