      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Inventaris Mobil</h1>
            <ol class="breadcrumb">
            ...
            <div class="card-body" style="width: 100%;">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a role="button" class="btn btn-info" href="editMobil.php?id=<?php echo $d['id_Mobil']; ?>">UBAH</a> </button>
                    <a role="button" class="btn btn-danger" href="hapusMobil.php?id=<?php echo $d['id_Mobil']; ?>">HAPUS</a></button>
                  </td>
                </tr>
              <?php
              }
