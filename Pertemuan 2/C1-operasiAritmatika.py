...
class ShowImage(QMainWindow):
    def __init__(self):
        ...
        self.actionTambah_Kurang_Kali_Bagi.triggered.connect(self.aritmatika)
    ...
    def aritmatika(self):
        image1 = cv2.imread('jantung.jpg', 0)
        image2 = cv2.imread('lung.jpg', 0)
    ...
    def operasiAND(self):
        image1 = cv2.imread('jantung.jpg', 1)
        image2 = cv2.imread('lung.jpg', 1)
